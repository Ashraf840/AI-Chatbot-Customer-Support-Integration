...
urlpatterns = [
    ...
    #path("language-detection/detect", ld.LanguageDetectionAPIView.as_view(), name="LanguageDetectionAPIView")
    path("language-detection/detect", ld.lang_detector, name="LanguageDetectionAPIView")
