...
function generateLocationOptions(location) {
    switch (location) {
        case 'start_location':
            let apiUrl_startLoc = `http://ibaschat.celloscope.net/tada-portal/get-location-list/?location_state=start_location&language=bn`;
            ...
            break;
        case 'end_location':
            let apiUrl_endLoc = `http://ibaschat.celloscope.net/tada-portal/get-location-list/?location_state=end_location&language=bn`;
